...
class AuthentificationBloc extends Bloc<AuthentificationEvent, AuthenticationState> {

  final UserRepository _userRepository;

  AuthentificationBloc( UserRepository userRepository): assert(userRepository != null),
  _userRepository = userRepository, super(Uninitialized());

  @override
  AuthenticationState get initalState => Uninitialized();
