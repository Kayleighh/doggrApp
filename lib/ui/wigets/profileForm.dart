...
import 'package:doggr2/bloc/authentification/authentification_event.dart';
...
import 'package:doggr2/ui/wigets/gender.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<ProfileBloc, ProfileState>(
      ...
      listener: (context, state) {
        ...
        if (state.isSuccess) {
          print("Success!");
          BlocProvider.of<AuthentificationBloc>(context).add(LoggedIn());
        }
      },
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          genderWidget(
                              FontAwesomeIcons.male, "Human", size, gender,
                                  () {
                                setState(() {
                                  gender = "Human";
                                });
                          ...
                          genderWidget(
                              FontAwesomeIcons.dog, "Dog", size, gender, () {
                            setState(() {
                              gender = "Dog";
                            });
                          }),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: <Widget>[
                          genderWidget(FontAwesomeIcons.male, "Human", size,
                              interestedIn, () {
                                setState(() {
                                  interestedIn = "Human";
                                });
                          ...
                          genderWidget(
                              FontAwesomeIcons.dog, "Dog", size, interestedIn,
                                  () {
                                setState(() {
                                  interestedIn = "Dog";
                                });
